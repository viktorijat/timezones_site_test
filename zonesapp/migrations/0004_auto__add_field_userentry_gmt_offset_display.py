...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserEntry.gmt_offset_display'
        db.add_column(u'zonesapp_userentry', 'gmt_offset_display',
                      self.gf('django.db.models.fields.TimeField')(default='00:00:00'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserEntry.gmt_offset_display'
        db.delete_column(u'zonesapp_userentry', 'gmt_offset_display')
