...
urlpatterns = [
    ...
    #    model=Timezone,
    #)),
    #url(r'^$', EntryListView.as_view(), name='EntryListView'),
    ...
    url(r'^profile/entry_list/$', list_view.entry_list, name='entry_list'),
    url(r'^profile/submit_entry/', submit_entry.submit_entry, name='submit_entry'),
    url(r'^profile/check_city/', submit_entry.check_city, name='check_city'),

    url(r'^profile/logout_event/', logout.logout_event, name='logout_event'),

    url(r'^profile/delete_by_id/$', delete_entry.delete_by_id, name='delete_by_id'),
    url(r'^profile/edit_by_id/$', edit_entry.edit_by_id, name='edit_by_id'),

    # url('^profile/delete_by_id/(?P<id>.+)/$', delete_entry.delete_by_id, name='delete_by_id'),
    #url('^profile/edit_entry/(?P<id>.+)/$', edit_entry.edit_by_id, name='edit_by_id'),

    #url(r'^entry_list/(?P<entry_name>.+)/$', list_view.EntryListView.as_view(), name='entry_list'),
